...
elif sex1 == "M" and estcv1 == "C":
    newslr1 = slr1 * 1.30
    print(f"\no Salário de {clb1} passou de R${slr1} para R$ {newslr1}")
else:
    print(f"\nO(a) {clb1}, não faz jus ao aumento de salário")
...
elif sex2 == "M" and estcv2 == "C":
    newslr2 = slr2 * 1.30
    print(f"\no Salário de {clb2} passou de R${slr2} para R$ {newslr2}")
else:
    print(f"\nO(a) {clb2}, não faz jus ao aumento de salário")
...
elif sex3 == "M" and estcv3 == "C":
    newslr3 = slr3 * 1.30
    print(f"\no Salário de {clb3} passou de R${slr3} para R$ {newslr3}")
else:
    print(f"\nO(a) {clb3}, não faz jus ao aumento de salário")